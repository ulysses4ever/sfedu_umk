...
\newcommand{\myunithours}[3]{%
	% вычисления производятся в предположении, что аудиторные и
	% дистантные часы совпадают, если это не так, то нужно будет
	% задать один необязательный аргумент команде \printhours
	% (подробнее см. определение \printhours в umk_preamble.tex)
...
%
	...
	\addtocounter{hallHours}{\value{distantUnitHours}}
%
